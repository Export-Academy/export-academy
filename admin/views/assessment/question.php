    ...
    <div class="border bg-light p-3 my-2">
      ...
      <div class="hstack justify-content-between">
        ...
        <div class="hstack gap-1">
          ...
          <button type="button" class="btn btn-sm btn-light delete-button" data-id="<?= $question->id ?>" data-type="<?= Question::class ?>">Delete Question</button>
        </div>
      </div>
      <hr>
          ...
          <?php if ($linkedQuestion) : ?>
            ...
            <div class="bg-white border my-2 hstack gap-3 justify-content-between p-2">
              ...
              <div class="hstack gap-2">
                ...
                <button type="button" data-type="<?= Question::class ?>" data-id="<?= $question->id ?>" class="btn btn-sm unlink-button" data-toggle="tooltip" title="Unlink Question"><i data-feather="link" width="16" height="16"></i></button>
              </div>
      ...
      ?>
        <div class="p-3 bg-white border my-2">
          ...
          <div class="vstack gap-2 justify-content-between">
            ...
            <?php if ($linked) : ?>
              <div class="bg-white border my-2 hstack gap-3 justify-content-between p-2">
                ...
                <div class="hstack gap-2">
                  <a href="<?= Helper::getURL("/admin/assessment/question?id=" . $linked->id) ?>" class="btn btn-sm btn-light border">Edit</a>
                  <button type="button" data-type="<?= Answer::class ?>" data-id="<?= $answer->id ?>" class="btn btn-sm unlink-button" data-toggle="tooltip" title="Unlink Question"><i data-feather="link" width="16" height="16"></i></button>
                </div>
              </div>
            <?php else : ?>
          ...
          <div class="hstack justify-content-end border-top pt-1 mt-1">
            ...
            <button type="button" class="btn btn-sm delete-button" data-toggle="tooltip" title="Delete Answer" data-id="<?= $answer->id ?>" data-type="<?= Answer::class ?>"><i data-feather="trash" width="16" height="16"></i></button>
          </div>
          <?= Html::form_end() ?>
        </div>
      <?php endforeach; ?>
